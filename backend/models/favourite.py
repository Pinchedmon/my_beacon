...
class Favourite(Base):
    ...
    files: Mapped[list["File"]] = relationship(back_populates="favourite", cascade="all, delete-orphan")
    tags: Mapped[list["Tag"]] =relationship(back_populates="favourites", secondary="tag_favourite")
    user_likes: Mapped[list["User"]] =relationship(back_populates="favourites", secondary="like_user")
